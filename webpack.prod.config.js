...
module.exports = {
    mode: 'production',
    entry: {
        // main:["@babel/polyfill", "./src/index.js"],//为了corejs3,polyfill不再维护了
        main: './src/index.js',
    },
    output: {
        ...
        publicPath:
            '/' /*打包完成时当前目录下的，一般情况下publicPath应该以'/'结尾，而其他loader或插件的配置不要以'/'开头*/,
    },
    resolve: {
        alias: {
    ...
    optimization: {
        minimizer: [
            ...
            new OptimizeCSSAssetsPlugin(
                {}
            ) /*这个插件是用来压缩css代码的,和postcss里面的cssnano是一样的,都能去除注释, 这个比用cssnano好*/,
        ],
        namedChunks: true,
        runtimeChunk: true,
        splitChunks: {
